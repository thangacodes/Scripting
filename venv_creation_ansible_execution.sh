...
ls -lrt
prGreen
echo "Executing python script via Ansible-Playbook..."
ls -lt
cat << EOF > copy.yml
---
- name: Executing a python script via ansible
  hosts: localhost
  become: yes
...
prBlue
echo "Ansible-playbook execution begin...."
